...
// move_calibrated(toggle_phase[1], left_speed, right_speed);   ->  Back
// move_calibrated(toggle_phase[2], left_speed, right_speed);   ->  Left
// move_calibrated(toggle_phase[3], left_speed, right_speed);   ->  Right
